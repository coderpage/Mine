...
public class RecordsActivityOld extends BaseActivity implements UpdatableView<RecordsModel,
    ...
    public void onEventRecordUpdate(EventRecordUpdate event) {
        Bundle args = new Bundle(1);
        args.putLong(RecordsModel.EXTRA_EXPENSE_ID, event.getRecord().getId());
    ...
    public Context getContext() {
        return RecordsActivityOld.this;
    }
